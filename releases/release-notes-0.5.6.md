...
### Features
- **Native floating sidebar for macOS 15+ with traffic lights inside panel**
- **Color scheme switching (light/dark/auto) via command palette**

### Enhancements
- Redesigned translation progress bar with minimal top-edge style
- Improved profile dialogs with minimal and elegant design

## 📥 Installation

**Recommended: DMG Installer**
1. Download `Flakes-v0.5.6-macOS.dmg`
2. Open the DMG file
3. Drag **Flakes.app** to the Applications folder shortcut
4. Launch Flakes Browser from Applications

**Alternative: ZIP Archive**
1. Download `Flakes-v0.5.6-macOS.zip`
